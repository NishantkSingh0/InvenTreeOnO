...
export async function activateLocale(locale: string | null) {
  ...
  try {
    const loaders = {
      en: () => import('../locales/en/messages.d.ts'),
      de: () => import('../locales/de/messages.d.ts'),
      fr: () => import('../locales/fr/messages.d.ts'),
      hi: () => import('../locales/hi/messages.d.ts')
      // add others
    };

    const loadLocale = loaders[localeDir as keyof typeof loaders];
